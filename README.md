...
| 💻 **CLI (Windows)** | [Download from Releases](https://github.com/Yac0z/speed-test-app/releases) |
| 🤖 **MCP Server** | [Download from Releases](https://github.com/Yac0z/speed-test-app/releases) |
