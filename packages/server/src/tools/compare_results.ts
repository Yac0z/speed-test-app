...
export async function compareResultsHandler(
  ...
  if (history.length === 0) {
    throw new Error('No saved results found. Run a speed test first.');
  }
